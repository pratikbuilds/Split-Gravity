...
const SECTION_FIVE_PILLAR_ZIGZAG: LevelSection = {
  ...
  platforms: [
    ...
    { surface: 'pillar', xTiles: 2, yTiles: 0, widthTiles: 4, heightTiles: 1, yCorridorRatio: 0.3 },
...
const SECTION_CEILING_DROP_HARD: LevelSection = {
  ...
  platforms: [
    ...
    { surface: 'pillar', xTiles: 5, yTiles: 0, widthTiles: 3, heightTiles: 1, yCorridorRatio: 0.3 },
    {
      surface: 'pillar',
      xTiles: 14,
      yTiles: 0,
...
// Order: intro → easy/recovery → medium → hard. Keeps jumps and landings feel fair.
export const LEVEL_SECTIONS: LevelSection[] = [
  ...
  SECTION_RAPID_FLIP,
  //TODO Need to review and fix the other levels
